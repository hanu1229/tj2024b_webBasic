...
<html>
			...
			<div class="row align-items-center g-lg-5 py-5">
				...
				<div class="col-md-10 mx-auto col-lg-5">
					<form id = "signupform" class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
						...
						<div class="form-floating mb-3">
							<input type="text" name = "mname" class="form-control" id="floatingName" placeholder="닉네임">
							<label for="floatingPassword">닉네임</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" name = "mphone" class="form-control" id="floatingPhone" placeholder="연락처">
							<label for="floatingPassword">연락처</label>
						</div>
						<div class="form-floating mb-3">
							<input type="file" name = "uploadfile" class="form-control" id="floatingUploadFile" placeholder="프로필">
							<label for="floatingPassword">프로필</label>
						</div>
	...
	<script src = "/tj2024b_webBasic/js/member/signup.js"></script>
	</body>
</html>